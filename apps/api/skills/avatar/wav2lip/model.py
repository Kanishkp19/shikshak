"""
Shikshak AI — Wav2Lip Generator Network Architecture.

Faithful PyTorch implementation of Wav2Lip (ACM Multimedia 2020)
by Rudrabha Mukhopadhyay et al. Compatible with official `wav2lip_gan.pth`
and `wav2lip.pth` checkpoint weights.
"""
...
class Conv2d(nn.Module):
    def __init__(self, cin: int, cout: int, kernel_size: int | tuple[int, int], stride: int | tuple[int, int], padding: int | tuple[int, int], residual: bool = False, *args, **kwargs):
...
class Conv2dTranspose(nn.Module):
    def __init__(self, cin: int, cout: int, kernel_size: int | tuple[int, int], stride: int | tuple[int, int], padding: int | tuple[int, int], output_padding: int | tuple[int, int] = 0, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.conv_block = nn.Sequential(
...
class Wav2Lip(nn.Module):
    """Wav2Lip Lip-Sync Generator Network."""
